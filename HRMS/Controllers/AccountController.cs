        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.Failure:
                    TempData[ApplicationConstants.KeyError] = ApplicationConstants.MessageInvallidLogin;
                    return PartialView(model);
                default:
                    TempData[ApplicationConstants.KeyError] = result +" " + ApplicationConstants.MessageNotFound;
                    return PartialView(model);
            }
        }
